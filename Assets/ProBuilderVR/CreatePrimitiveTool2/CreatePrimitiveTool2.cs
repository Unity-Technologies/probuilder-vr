...
{
	[SerializeField]
	CreatePrimitiveMenu2 m_MenuPrefab;
	...
	void Start()
	{
		...
		var createPrimitiveMenu2 = m_ToolMenu.GetComponent<CreatePrimitiveMenu2>();
		connectInterfaces(createPrimitiveMenu2, rayOrigin);
		createPrimitiveMenu2.selectPrimitive = SetSelectedPrimitive;
	}
